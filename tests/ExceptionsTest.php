...
class ExceptionsTest extends TestCase
{
    ...
    {
        $this->expectException(\Elnooronline\Breadcrumbs\Exceptions\DuplicateBreadcrumbException::class);
    ...
    {
        $this->expectException(\Elnooronline\Breadcrumbs\Exceptions\InvalidBreadcrumbException::class);
    ...
    {
        $this->expectException(\Elnooronline\Breadcrumbs\Exceptions\ViewNotSetException::class);
